...
import net.minecraft.world.spawner.WorldEntitySpawner;
	...
	public class SkeletonChunkGenerator extends NoiseChunkGenerator<SkeletonGenSettings> {
	   ...
	   public SkeletonChunkGenerator(IWorld worldIn, BiomeProvider provider, SkeletonGenSettings settingsIn) {
