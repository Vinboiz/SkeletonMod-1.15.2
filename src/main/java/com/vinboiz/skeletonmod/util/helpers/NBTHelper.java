...
public class NBTHelper {
	...
	public static CompoundNBT toNBT(Object o) {
		...
		if(o instanceof ExcavatorTileEntity) {
			return writeSkeletonExcavator((ExcavatorTileEntity)o);
		}
		
		return null;
	}
	
	private static CompoundNBT writeSkeletonExcavator(ExcavatorTileEntity o) {
