...
public class ExcavatorTileEntity extends TileEntity implements ITickableTileEntity{

	
	public int x, y, z, tick;
	boolean initialized = false;

	public ExcavatorTileEntity(final TileEntityType<?> tileEntityTypeIn) {
		super(tileEntityTypeIn);
	}

	public ExcavatorTileEntity() {
		this(ModTileEntityTypes.EXCAVATOR.get());
	}
